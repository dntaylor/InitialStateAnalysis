...
def get_parser(desc):
    ...
    parser.add_argument('channel', type=str, choices=['Z','WZ','FakeRate','HZZFakeRate','TT','Hpp2l','Hpp3l','Hpp4l','ZZ','HppAP','HppPP','HppComb','LowMass','Charge'], help='Channel to run for given analysis')
