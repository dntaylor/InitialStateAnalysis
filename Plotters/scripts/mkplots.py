...
def plotDistributions(plotMethod,myCut,nl,isControl,**kwargs):
    ...
    doDetailed = kwargs.pop('doDetailed',True)
    if savedir: savedir += '/'
    ...
    for l in range(nl):
        ...
        if doDetailed:
            plotMethod('%s.Dxy' %name,[50,-0.5,0.5],savedir+'%sDxy' %name,yaxis='Events',xaxis='d_{0}^{\\ell%i}' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.Dz' %name,[50,-0.5,0.5],savedir+'%sDz' %name,yaxis='Events',xaxis='d_{Z}^{\\ell%i}' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.SigmaIEtaIEta' %name,[40,0.,0.08],savedir+'%sSigmaIEtaIEta' %name,yaxis='Events',xaxis='\\sigma_{i\\eta i\\eta}^{\\ell%i}' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.DEtaIn' %name,[50,-0.5,0.5],savedir+'%sDEtaIn' %name,yaxis='Events',xaxis='\\Delta\\eta_{In}^{\\ell%i}' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.DPhiIn' %name,[50,-0.5,0.5],savedir+'%sDPhiIn' %name,yaxis='Events',xaxis='\\Delta\\phi_{In}^{\\ell%i}' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.HOverE' %name,[50,0.,0.5],savedir+'%sHOverE' %name,yaxis='Events',xaxis='\\frac{H}{E}^{\\ell%i}' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.OoEmOoP' %name,[50,0.,0.5],savedir+'%sOoEmOoP' %name,yaxis='Events',xaxis='|\\frac{1}{E}-\\frac{1}{P}|^{\\ell%i}' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.TriggeringMVA' %name,[50,-1.,1.],savedir+'%sTriggeringMVA' %name,yaxis='Events',xaxis='MVA_{Triggering} (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.NonTriggeringMVA' %name,[50,-1.,1.],savedir+'%sNonTriggeringMVA' %name,yaxis='Events',xaxis='MVA_{NonTriggering} (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.ExpectedMissingInnerHits' %name,[6,0,6],savedir+'%sMissingHits' %name,yaxis='Events',xaxis='Missing Hits (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.PassConversionVeto' %name,[2,0,2],savedir+'%sPassConversion' %name,yaxis='Events',xaxis='Pass Conversion Veto (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.NormalizedChi2' %name,[50,0.,25.],savedir+'%sNormalizedChi2' %name,yaxis='Events',xaxis='\\chi_{Norm}^{2} (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.IsGlobalMuon' %name,[2,0,2],savedir+'%sIsGlobalMuon' %name,yaxis='Events',xaxis='Gloabl Muon (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.IsPFMuon' %name,[2,0,2],savedir+'%sIsPFMuon' %name,yaxis='Events',xaxis='PFMuon (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.IsTrackerMuon' %name,[2,0,2],savedir+'%sIsTrackerMuon' %name,yaxis='Events',xaxis='Tracker Muon (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.ValidMuonHits' %name,[80,0,80],savedir+'%sValidMuonHits' %name,yaxis='Events',xaxis='Muon Hits (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.MatchedStations' %name,[6,0,6],savedir+'%sMatchedStations' %name,yaxis='Events',xaxis='Matched Stations (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.ValidPixelHits' %name,[8,0,8],savedir+'%sValidPixelHits' %name,yaxis='Events',xaxis='Valid Pixel Hits (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('%s.TrackerLayers' %name,[20,0,20],savedir+'%sTrackerLayers' %name,yaxis='Events',xaxis='Tracker Layers (\\ell%i)' %(l+1),legendpos=43,logy=0,cut=myCut,**kwargs)
    ...
    if analysis in ['Hpp4l']:
        ...
        #plotMethod('h2.mass', [24,0,600],savedir+'hmmMass_mod',          yaxis='Events/25.0 GeV/c^{2}',xaxis='M_{\\ell^{+}\\ell^{+}} (GeV/c^{2})',              lumitext=33,legendpos=41,logy=1,cut=myCut,overflow=True,**kwargs)
        plotMethod('h2.mass', [32,0,800],savedir+'hmmMass_alpha',        yaxis='Events/25.0 GeV/c^{2}',xaxis='M_{\\ell^{\\pm}\\ell^{\\pm}} (GeV/c^{2})', lumitext=33,logy=1,cut=myCut,boxes=[[12,0.9*mass,1],[1.1*mass,800,1],[0.9*mass,1.1*mass,2]],**kwargs)
        plotMethod('h2.dPhi', [32,0,3.2],savedir+'hmmDphi',              yaxis='Events/0.1 rad',       xaxis='\\Delta\\phi_{\\ell^{\\pm}\\ell^{\\pm}} (rad)',   legendpos=41,lumitext=33,logy=0,cut=myCut,**kwargs)
        plotMethod('h2.Pt',   [40,0,400],savedir+'hmmPt',                yaxis='Events/10.0 GeV',      xaxis='p_{T}^{\\Phi^{\\pm\\pm}} (GeV)',                  legendpos=43,logy=0,cut=myCut,overflow=True,**kwargs)
        plotMethod('h2.Pt1',  [40,0,200],savedir+'hmmLeadingLeptonPt',   yaxis='Events/5.0 GeV',       xaxis='p_{T}^{\\Phi^{\\pm\\pm} Leading Lepton} (GeV)',   legendpos=43,logy=0,cut=myCut,overflow=True,**kwargs)
        plotMethod('h2.Pt2',  [40,0,200],savedir+'hmmSubleadingLeptonPt',yaxis='Events/5.0 GeV',       xaxis='p_{T}^{\\Phi^{\\pm\\pm} Subleading Lepton} (GeV)',legendpos=43,logy=0,cut=myCut,overflow=True,**kwargs)
        plotMethod('h2.Iso1', [50,0,0.5],savedir+'hmmLeadingIso',        yaxis='Events',               xaxis='Iso/p_{T} (\\Phi^{\\pm\\pm} Leading Lepton)',     legendpos=43,logy=0,cut=myCut,overflow=True,**kwargs)
        plotMethod('h2.Iso2', [50,0,0.5],savedir+'hmmSubleadingIso',     yaxis='Events',               xaxis='Iso/p_{T} (\\Phi^{\\pm\\pm} Subleading Lepton)',  legendpos=43,logy=0,cut=myCut,overflow=True,**kwargs)
        plotMethod('h2.dR',   [60,0,6], savedir+'hmmdR',                 yaxis='Events',               xaxis='\\Delta R(\\ell^{\\pm}\\ell^{\\pm})',             legendpos=43,logy=0,cut=myCut,**kwargs)
    # plot Z stuff
    if analysis in ['Z', 'Hpp3l', 'Hpp4l', 'WZ', 'WZ_W'] or region in ['Z', 'TT']:
        ...
        if doDetailed:
            plotMethod('z1.Dxy1',                     [50,-0.5,0.5],savedir+'z1LeadingDxy',                yaxis='Events',xaxis='d_{0}',                      legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.Dz1',                      [50,-0.5,0.5],savedir+'z1LeadingDz',                 yaxis='Events',xaxis='d_{Z}',                      legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.SigmaIEtaIEta1',           [40,0.,0.08], savedir+'z1LeadingSigmaIEtaIEta',      yaxis='Events',xaxis='\\sigma_{i\\eta i\\eta}',    legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.DEtaIn1',                  [50,-0.5,0.5],savedir+'z1LeadingDEtaIn',             yaxis='Events',xaxis='\\Delta\\eta_{In}',          legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.DPhiIn1',                  [50,-0.5,0.5],savedir+'z1LeadingDPhiIn',             yaxis='Events',xaxis='\\Delta\\phi_{In}',          legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.HOverE1',                  [50,0.,0.5],  savedir+'z1LeadingHOverE',             yaxis='Events',xaxis='\\frac{H}{E}',               legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.OoEmOoP1',                 [50,0.,0.5],  savedir+'z1LeadingOoEmOoP',            yaxis='Events',xaxis='|\\frac{1}{E}-\\frac{1}{P}|',legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.TriggeringMVA1',           [50,-1.,1.],  savedir+'z1LeadingTriggeringMVA',      yaxis='Events',xaxis='MVA_{Triggering}',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.NonTriggeringMVA1',        [50,-1.,1.],  savedir+'z1LeadingNonTriggeringMVA',   yaxis='Events',xaxis='MVA_{NonTriggering}',        legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.ExpectedMissingInnerHits1',[6,0,6],      savedir+'z1LeadingMissingHits',        yaxis='Events',xaxis='Missing Hits',               legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.PassConversionVeto1',      [2,0,2],      savedir+'z1LeadingPassConversion',     yaxis='Events',xaxis='Pass Conversion Veto',       legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.NormalizedChi21',          [50,0.,25.],  savedir+'z1LeadingNormalizedChi2',     yaxis='Events',xaxis='\\chi_{Norm}^{2}',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.IsGlobalMuon1',            [2,0,2],      savedir+'z1LeadingIsGlobalMuon',       yaxis='Events',xaxis='Gloabl Muon',                legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.IsPFMuon1',                [2,0,2],      savedir+'z1LeadingIsPFMuon',           yaxis='Events',xaxis='PFMuon',                     legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.IsTrackerMuon1',           [2,0,2],      savedir+'z1LeadingIsTrackerMuon',      yaxis='Events',xaxis='Tracker Muon',               legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.ValidMuonHits1',           [80,0,80],    savedir+'z1LeadingValidMuonHits',      yaxis='Events',xaxis='Muon Hits',                  legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.MatchedStations1',         [6,0,6],      savedir+'z1LeadingMatchedStations',    yaxis='Events',xaxis='Matched Stations',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.ValidPixelHits1',          [8,0,8],      savedir+'z1LeadingValidPixelHits',     yaxis='Events',xaxis='Valid Pixel Hits',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.TrackerLayers1',           [20,0,20],    savedir+'z1LeadingTrackerLayers',      yaxis='Events',xaxis='Tracker Layers',             legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.Dxy2',                     [50,-0.5,0.5],savedir+'z1SubLeadingDxy',             yaxis='Events',xaxis='d_{0}',                      legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.Dz2',                      [50,-0.5,0.5],savedir+'z1SubLeadingDz',              yaxis='Events',xaxis='d_{Z}',                      legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.SigmaIEtaIEta2',           [40,0.,0.08], savedir+'z1SubLeadingSigmaIEtaIEta',   yaxis='Events',xaxis='\\sigma_{i\\eta i\\eta}',    legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.DEtaIn2',                  [50,-0.5,0.5],savedir+'z1SubLeadingDEtaIn',          yaxis='Events',xaxis='\\Delta\\eta_{In}',          legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.DPhiIn2',                  [50,-0.5,0.5],savedir+'z1SubLeadingDPhiIn',          yaxis='Events',xaxis='\\Delta\\phi_{In}',          legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.HOverE2',                  [50,0.,0.5],  savedir+'z1SubLeadingHOverE',          yaxis='Events',xaxis='\\frac{H}{E}',               legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.OoEmOoP2',                 [50,0.,0.5],  savedir+'z1SubLeadingOoEmOoP',         yaxis='Events',xaxis='|\\frac{1}{E}-\\frac{1}{P}|',legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.TriggeringMVA2',           [50,-1.,1.],  savedir+'z1SubLeadingTriggeringMVA',   yaxis='Events',xaxis='MVA_{Triggering}',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.NonTriggeringMVA2',        [50,-1.,1.],  savedir+'z1SubLeadingNonTriggeringMVA',yaxis='Events',xaxis='MVA_{NonTriggering}',        legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.ExpectedMissingInnerHits2',[6,0,6],      savedir+'z1SubLeadingMissingHits',     yaxis='Events',xaxis='Missing Hits',               legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.PassConversionVeto2',      [2,0,2],      savedir+'z1SubLeadingPassConversion',  yaxis='Events',xaxis='Pass Conversion Veto',       legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.NormalizedChi22',          [50,0.,25.],  savedir+'z1SubLeadingNormalizedChi2',  yaxis='Events',xaxis='\\chi_{Norm}^{2}',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.IsGlobalMuon2',            [2,0,2],      savedir+'z1SubLeadingIsGlobalMuon',    yaxis='Events',xaxis='Gloabl Muon',                legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.IsPFMuon2',                [2,0,2],      savedir+'z1SubLeadingIsPFMuon',        yaxis='Events',xaxis='PFMuon',                     legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.IsTrackerMuon2',           [2,0,2],      savedir+'z1SubLeadingIsTrackerMuon',   yaxis='Events',xaxis='Tracker Muon',               legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.ValidMuonHits2',           [80,0,80],    savedir+'z1SubLeadingValidMuonHits',   yaxis='Events',xaxis='Muon Hits',                  legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.MatchedStations2',         [6,0,6],      savedir+'z1SubLeadingMatchedStations', yaxis='Events',xaxis='Matched Stations',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.ValidPixelHits2',          [8,0,8],      savedir+'z1SubLeadingValidPixelHits',  yaxis='Events',xaxis='Valid Pixel Hits',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('z1.TrackerLayers2',           [20,0,20],    savedir+'z1SubLeadingTrackerLayers',   yaxis='Events',xaxis='Tracker Layers',             legendpos=43,logy=0,cut=myCut,**kwargs)
    ...
    if analysis in ['Hpp3l', 'WZ', 'WZ_W', 'WZ_FakeRate']:
        ...
        if doDetailed:
            plotMethod('w1.Dxy1',                     [50,-0.5,0.5],savedir+'w1Dxy',                yaxis='Events',xaxis='d_{0}',                      legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.Dz1',                      [50,-0.5,0.5],savedir+'w1Dz',                 yaxis='Events',xaxis='d_{Z}',                      legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.SigmaIEtaIEta1',           [40,0.,0.08], savedir+'w1SigmaIEtaIEta',      yaxis='Events',xaxis='\\sigma_{i\\eta i\\eta}',    legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.DEtaIn1',                  [50,-0.5,0.5],savedir+'w1DEtaIn',             yaxis='Events',xaxis='\\Delta\\eta_{In}',          legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.DPhiIn1',                  [50,-0.5,0.5],savedir+'w1DPhiIn',             yaxis='Events',xaxis='\\Delta\\phi_{In}',          legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.HOverE1',                  [50,0.,0.5],  savedir+'w1HOverE',             yaxis='Events',xaxis='\\frac{H}{E}',               legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.OoEmOoP1',                 [50,0.,0.5],  savedir+'w1OoEmOoP',            yaxis='Events',xaxis='|\\frac{1}{E}-\\frac{1}{P}|',legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.TriggeringMVA1',           [50,-1.,1.],  savedir+'w1TriggeringMVA',      yaxis='Events',xaxis='MVA_{Triggering}',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.NonTriggeringMVA1',        [50,-1.,1.],  savedir+'w1NonTriggeringMVA',   yaxis='Events',xaxis='MVA_{NonTriggering}',        legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.ExpectedMissingInnerHits1',[6,0,6],      savedir+'w1MissingHits',        yaxis='Events',xaxis='Missing Hits',               legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.PassConversionVeto1',      [2,0,2],      savedir+'w1PassConversion',     yaxis='Events',xaxis='Pass Conversion Veto',       legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.NormalizedChi21',          [50,0.,25.],  savedir+'w1NormalizedChi2',     yaxis='Events',xaxis='\\chi_{Norm}^{2}',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.IsGlobalMuon1',            [2,0,2],      savedir+'w1IsGlobalMuon',       yaxis='Events',xaxis='Gloabl Muon',                legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.IsPFMuon1',                [2,0,2],      savedir+'w1IsPFMuon',           yaxis='Events',xaxis='PFMuon',                     legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.IsTrackerMuon1',           [2,0,2],      savedir+'w1IsTrackerMuon',      yaxis='Events',xaxis='Tracker Muon',               legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.ValidMuonHits1',           [80,0,80],    savedir+'w1ValidMuonHits',      yaxis='Events',xaxis='Muon Hits',                  legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.MatchedStations1',         [6,0,6],      savedir+'w1MatchedStations',    yaxis='Events',xaxis='Matched Stations',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.ValidPixelHits1',          [8,0,8],      savedir+'w1ValidPixelHits',     yaxis='Events',xaxis='Valid Pixel Hits',           legendpos=43,logy=0,cut=myCut,**kwargs)
            plotMethod('w1.TrackerLayers1',           [20,0,20],    savedir+'w1TrackerLayers',      yaxis='Events',xaxis='Tracker Layers',             legendpos=43,logy=0,cut=myCut,**kwargs)
